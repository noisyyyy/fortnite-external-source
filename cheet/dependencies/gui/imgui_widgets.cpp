...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.framecol = ImLerp(it_anim->second.framecol, *v ? ImColor(255, 0, 0) : hovered ? ImColor(30, 30, 30) : ImColor(25, 25, 25), g.IO.DeltaTime * 4.f);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 7, 16.5f), ImColor(255, 0, 0), 100, ImDrawFlags_RoundCornersLeft);// color change here
